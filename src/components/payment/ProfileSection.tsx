...
const ProfileSection = ({ username, profileData, isLoading = false }: ProfileSectionProps) => {
  ...
  if (isLoading) {
    return (
      <div className="p-4 bg-secondary/20 rounded-lg border border-primary/20 mb-4 glass-card shadow-[0_0_20px_rgba(0,255,170,0.2)]">
  ...
  return (
    <div className="p-6 bg-secondary/30 rounded-lg border border-primary/30 mb-4 glass-card shadow-[0_0_25px_rgba(0,255,170,0.25)] backdrop-blur-md transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,170,0.35)]">
      <div className="flex items-center gap-5">
        <div className="relative">
          <Avatar className="h-20 w-20 md:h-24 md:w-24 border-2 border-primary/50 shadow-[0_0_15px_rgba(0,255,170,0.35)] ring-2 ring-primary/20 ring-offset-2 ring-offset-background/50">
            ...
            <AvatarFallback className="bg-secondary/70 text-primary text-xl font-bold">
              {username?.substring(0, 2)?.toUpperCase()}
            </AvatarFallback>
          </Avatar>
          {profileData?.is_verified && (
            <div className="absolute -bottom-1 -right-1 bg-primary/90 p-1 rounded-full shadow-lg">
        ...
        <div className="space-y-2 flex-1">
          <div className="flex items-center gap-2">
            <h3 className="font-bold text-foreground text-xl">@{username}</h3>
            {profileData?.is_verified && (
          ...
          <div className="flex flex-wrap gap-3 mt-3">
            <div className="flex items-center gap-2 bg-secondary/50 px-3 py-1.5 rounded-full border border-primary/20 shadow-sm">
      ...
      {profileData?.bio && (
        <div className="mt-4 p-3 bg-secondary/40 rounded-lg border border-primary/20 shadow-inner">
